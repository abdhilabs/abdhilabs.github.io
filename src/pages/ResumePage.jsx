        ...
        {experience.highlights && (
          <ul className="space-y-1">
            {experience.highlights.map((highlight, index) => (
              <li
                key={index}
                className="text-sm text-gray-500 dark:text-gray-500 flex gap-3 leading-relaxed"
              >
                <span className="text-gray-300 dark:text-gray-700 flex-shrink-0 leading-relaxed">
                  •
                </span>
