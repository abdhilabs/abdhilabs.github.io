    ...
    <div className="max-w-2xl mx-auto px-6 py-12 lg:py-16">
      ...
      <section className="mb-16">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-semibold text-gray-900">Recent Writing</h2>
          <Link
            to="/blog"
            className="flex items-center gap-1 text-sm text-blue-600 hover:text-blue-700 transition-colors group"
          >
            View all
        ...
        <div className="space-y-4">
          {recentPosts.map((post) => (
            ...
            >
              <article className="p-4 -mx-4 rounded-xl hover:bg-gray-50 transition-colors duration-200">
      ...
      <section>
        ...
        <div className="space-y-3">
          {featuredProjects.map((project) => (
            <div
              key={project.id}
              className="p-4 -mx-4 rounded-xl hover:bg-gray-50 transition-colors duration-200 group"
            >
